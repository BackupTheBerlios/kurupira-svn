 ...
 * 
 * Interface of the Certificateless Public Key Cryptography aggregate signature
 * module.
 * 
 * @version $Header$
 * @ingroup libless
 */
...
#ifndef _LIBLESS_AGGREGATE_H_
	#define _LIBLESS_AGGREGATE_H_
	 ...
	 */
	int libless_aggregate_setup(libless_t *env, libless_params_t *params,
	 ...
	 * @returns LIBLESS_OK if no error occurs, LIBLESS_ERROR otherwise.
	 */
	int libless_aggregate_set_public(libless_t *env, libless_public_t *public_key,
	 ...
	 * @returns LIBLESS_OK if no error occurs, LIBLESS_ERROR otherwise.
	 */
	int libless_aggregate_set_private(libless_t *env, libless_private_t *private,
	 ...
	 * @param[in] ...           - the set (in_i, in_len_i) of messages to sign
	 * @returns LIBLESS_OK if no error occurs, LIBLESS_ERROR otherwise.
	 */
	...
	/**
	 * Verifies a aggregated signature with the user public key using batch
	 * verifications (the message.
	 * 
	 * @param[in,out] env       - the library context
